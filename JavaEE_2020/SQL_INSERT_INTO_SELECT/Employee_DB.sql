...
insert  into `employee`(`EMPLOYEE_ID`,`EMPLOYEE_NAME`,`AGE`,`SALARY`,`CREATED_DATE`) values (1,'Peter',32,7000,'2019-09-03'),(2,'Dave',34,8000,'2019-09-04'),(3,'John',45,10000,'2019-09-24'),(4,'Ajay',32,7000,'2019-09-18'),(5,'Vijay',40,8888,'2019-09-30'),(6,'Arun',56,NULL,'2019-09-16');
...
/*Data for the table `employeebackup` */
