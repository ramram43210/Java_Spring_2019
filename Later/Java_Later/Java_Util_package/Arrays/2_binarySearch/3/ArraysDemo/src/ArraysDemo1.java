...
public class ArraysDemo1
{
	...
	public static void main(String[] args)
	{
		...
		/*
		 * Searches the specified array of longs for the specified
		 * value using the binary search algorithm.
		 * 
		 * The array must be sorted (as by the sort(long[]) method)
		 ...
		 */
		int searchKey = 50;
		int indexOfSearchKey = Arrays.binarySearch(longArray, searchKey);
