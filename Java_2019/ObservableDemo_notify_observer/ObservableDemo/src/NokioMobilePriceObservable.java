...
public class NokioMobilePriceObservable extends Observable
{
	...
	public void setPrice(int newPrice)
	{
		...
		if (price != newPrice)
		{
			 ...
			 * its observers and then call the clearChanged method to indicate that this object has
			 * no longer changed.
			 * 
			 * Each observer has its update method called with two arguments: this observable object
			 * and the arg argument.
			 * 
			 * Parameters:
			 * 
			 * arg - any object.
